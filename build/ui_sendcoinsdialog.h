...
public:
    ...
    QCheckBox *checkCheetahcoinControlChange;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        checkCheetahcoinControlChange = new QCheckBox(frameCoinControl);
        checkCheetahcoinControlChange->setObjectName(QString::fromUtf8("checkCheetahcoinControlChange"));

        horizontalLayoutCoinControl4->addWidget(checkCheetahcoinControlChange);
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 FAST", 0, QApplication::UnicodeUTF8));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 FAST", 0, QApplication::UnicodeUTF8));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 FAST", 0, QApplication::UnicodeUTF8));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0, QApplication::UnicodeUTF8));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 FAST", 0, QApplication::UnicodeUTF8));
        checkCheetahcoinControlChange->setText(QApplication::translate("SendCoinsDialog", "custom change address", 0, QApplication::UnicodeUTF8));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 FAST", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
